	...
	<div class="titulo h5 mb-0"><h2>Formulario de cadastro</h2></div>
		<div class="base-form">
			<div class="caixa-form">
				<form action="<?php echo URL_BASE."fornec/salvar" ?>" method="POST">				
					<div class="rows">
					...
					<div class="rows msg-form">	
						...
						<div class="col-9">
							...
							<div class="col-4">
								...
								<input name="fornecedor" value="<?php echo isset($fornec) ? $fornec->fornecedor : "" ?>" type="text" placeholder="Insira seu fornecedores" class="form-campo">
							</div>

                            <div class="col-3">
                                <label>CNPJ</label>
                                <input name="cnpj" value="<?php echo isset($fornec) ? $fornec->cnpj : "" ?>" type="text" placeholder="Insira o CNPJ" class="form-campo">
                            </div>							
						
							<div class="col-4 m-auto">
								<input type="hidden" name="idF" value="<?php echo isset($fornec) ? $fornec->idF : null ?>" />
